...
<html lang="ko">
  <head>
    ...
    <link href="${rootPath}/static/css/nav.css?ver=2020-10-12-1" rel="stylesheet" />
  ...
  <script src="${rootPath}/static/js/nav.js?ver=2020-10-12-009" defer></script>
  ...
  <body>
    <nav class="navbar">
      ...
      <ul class="navbar__menu">
        ...
        <li><button type="button" id="button" class="myinfo" >${LOGIN.n_userid}님 환영합니다!</button></li>
