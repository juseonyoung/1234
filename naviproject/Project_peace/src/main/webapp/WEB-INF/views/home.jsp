...
<link href="${rootPath}/static/css/main.css?ver=2020-10-12-007"
	rel="stylesheet" />
<link href="${rootPath}/static/css/login_modal.css?ver=2020-10-12-002"
	rel="stylesheet" />
	...
	<section id="login_modal">
			...
			<div class="hero">
				<div id="form-box" class="form-box">
					...
					<form:form modelAttribute="MEM_VO" id="login" class="input-group"
						...
						<button id="btn_login" type="button" class="submit-btn"
							href="${rootPath}/map">Log in</button>
      ...
      $(function(){
    		$("#btn_resister").click(function(){
    			...
    			let n_userid = $("#register #n_userid").val();
    			let n_email = $("#register #n_email").val();
    			let n_password = $("#register #n_password").val();
    			alert(n_userid)
    			if(n_userid==""){
      ...
      $(".idCheck").click(function(){
    	var query = {n_userid : $("#register #n_userid").val()};
...
//    	}
    	...
    	$.ajax({
    		...
    		success: function(data){
    			...
    			if(data == 1){
    				$(".result .checkMsg").text("사용 할 수 없는 ID입니다");
    				$(".result .checkMsg").attr("style","color:#f00")
    				$("#submit").attr("disabled", "disabled");
    			} else if(data == 0){
    				$(".result .checkMsg").text("사용 할 수 있는 ID입니다");
    				$(".result .checkMsg").attr("style","color:#00f")
