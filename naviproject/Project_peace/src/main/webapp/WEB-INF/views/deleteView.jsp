			...
			<div class="password-check">
				...
				<div class="form-holder">
					...
					<div class="form-group">
						<label class="control-label" for="n_userid">아이디</label>
						<input class="form-control" type="text" id="n_userid" name="n_userid"
					value="${LOGIN.n_userid}" readonly="readonly" />
					</div>
					
					<div class="form-group">
						<label class="control-label" for="n_password">패스워드</label>
						<input
