...
public class HomeController {
	...
	public String login(@ModelAttribute("MEM_VO") MemberVO loginVO, MemberVO memVO,
	...
	public String mypage(HttpSession httpSession, @ModelAttribute("MEM_VO") MemberVO memVO) {

		// log.debug("mypage GET 고객정보 확인 : ",member.toString() );
	...
	public String mypage(MemberVO memVO, HttpSession httpSession) {
		...
		MemberVO memberVO = (MemberVO) httpSession.getAttribute("LOGIN");
		 ...
		 log.debug("mypage POST 고객정보 확인 : " + memberVO.toString());
